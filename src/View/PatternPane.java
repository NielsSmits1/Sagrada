...
public class PatternPane extends StackPane {
	...
	/// *
	// BoardPane is required to get and delete the selected DicePane from RootPane.
	/// The required DicePane will become the template
	/// **
	public PatternPane(BoardPane p, DicePane d, int x, int y) {
		...
		yPos = y;
		/// *
		// If selected is not null, the dice will become the selected DicePane. Dice
		/// can't be clicked again when this happens, the selected DicePane will be set
		/// to null and dice will be added to the stackPane.
